(function () {
    ...
    window.DietApi = {
        ...
        copyPublicMealToPersonal: (mealId) => request(`/meals/public/${encodeURIComponent(mealId)}/copy-to-personal`, { method: "POST" }),
        importMealToPersonal: (mealId) => request(`/meals/${encodeURIComponent(mealId)}/import-to-personal`, { method: "POST" }),
